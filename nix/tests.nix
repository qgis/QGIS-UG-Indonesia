...

{
  ...
  test-smoke = pkgs.runCommand "test-smoke"
    ...
    ''
      ...
      check_content "/" "Menghubungkan pengguna QGIS di Indonesia" "Homepage has tagline"
      check_content "/" "Selamat Datang di QGIS Indonesia" "Homepage has welcome heading"

      # Key section pages
      check_status "/about-us/" "200" "About page returns HTTP 200"
      check_content "/about-us/" "Tentang Kami" "About page has expected content"

      check_status "/community/" "200" "Community page returns HTTP 200"
      check_content "/community/" "Ekosistem QGIS Indonesia" "Community page has expected content"

      check_status "/events/" "200" "Events page returns HTTP 200"
      check_content "/events/" "Acara Mendatang" "Events page has expected content"
