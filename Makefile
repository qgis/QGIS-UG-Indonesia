help:
	...
	@echo "https://github.com/QGIS/QGIS-User-Group-Website"
	@echo
	@echo "------------------------------------------------------------------"
...
build: ## Build the site for id.qgis.org
	@echo
	@echo "------------------------------------------------------------------"
...
deploy: ## Deploy the site for id.qgis.org
	@echo
	@echo "------------------------------------------------------------------"
...
revert-deploy: ## Revert the site for id.qgis.org
	@echo
	@echo "------------------------------------------------------------------"
